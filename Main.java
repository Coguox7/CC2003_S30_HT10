...
//Crea lista con los datos del txt
        ...
        while((line = br.readLine()) != null){ //Mientras hayan lineas
            ...
            String destino = parts[1]; //Destino = indice 1
...
//Se crea una matrizGrafo de Strings del mismmo tamaño que la cantidad de elementos de la lista 
/*********************************************************************/
